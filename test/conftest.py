from test.db.dependencies import get_db_session
from test.db.utils import create_database, drop_database
from test.services.kafka.dependencies import get_kafka_producer
from test.services.kafka.lifetime import init_kafka, shutdown_kafka
from test.settings import settings
from test.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from test.db.meta import meta  # noqa: WPS433
    from test.db.models import load_all_models  # noqa: WPS433
